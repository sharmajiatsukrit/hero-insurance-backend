...
export default class CorporateInsuranceTypeController {
    ...
    public async getList(req: Request, res: Response): Promise<any> {
        try {
            ...
            const results = await CorporateInsuranceType.find(searchQuery).sort({ _id: -1 }).skip(skip).limit(limitNumber).lean();

            const totalCount = await CorporateInsuranceType.countDocuments(searchQuery);
    ...
    public async getById(req: Request, res: Response): Promise<any> {
        try {
            ...
            const result: any = await CorporateInsuranceType.findOne({ id: id }).lean();
    ...
    public async add(req: Request, res: Response): Promise<any> {
        try {
            ...
            const { name } = req.body;
            await CorporateInsuranceType.create({
                name: name,
    ...
    public async update(req: Request, res: Response): Promise<any> {
        try {
            ...
            let result: any = await CorporateInsuranceType.findOneAndUpdate(
                { id: id },
                {
                    name: name,
                    status: status,
    ...
    public async delete(req: Request, res: Response): Promise<any> {
        try {
            ...
            const id = parseInt(req.params.id);
            const result = await CorporateInsuranceType.deleteOne({ id: id });
    ...
    public async status(req: Request, res: Response): Promise<any> {
        try {
            ...
            const updationstatus = await CorporateInsuranceType.findOneAndUpdate({ id: id }, { status: status }).lean();
            if (updationstatus) {
